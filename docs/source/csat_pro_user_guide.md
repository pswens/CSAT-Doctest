...
### System Admin Pages ###
System Admins have several pages available to them that users with a Basic system profile do not.  Note: System Admins navigating from System Admin specific pages such as User Management and Organization Management pages will remain on the System Admin track of pages, which differs from the Organization track of pages. However, if a System Admin also has organization roles, they can navigate through the standard Organization track of pages via the Organization Info pages accessible from the My Organizations and My Assessments sections of their Home Page.
...
System Admins can use the “Edit User” icon in the Action column to change the user’s information or to disable that user (a disabled user will not be able to log into the CSAT Pro instance).  System Admins may not edit their own user details from this menu, but can instead edit their info with “My Profile” under their username in the top menu. A user’s organization roles can also be viewed or modified from this page (though these modifications are subject to certain assessment workflow assignment restrictions which are noted in the tool when attempting to make these modifications).
...
####Edit Assessment####
Users with an Organization Admin role for an assessment can edit the name, start date, due date, and date closed of that assessment.  The Edit Assessment page can be reached from the Action column of an assessment’s row on either the My Assessments section on the Home page or the Assessments section of an Organization Info page.  On the Edit Assessment page, users can update the desired fields and click Save to update the information for that assessment.
